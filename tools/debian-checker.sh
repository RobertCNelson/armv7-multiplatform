...
check_config_module
config="CONFIG_KEYBOARD_SH_KEYSC"
check_config_module
...
value="0"
check_config_value
config="CONFIG_SECURITY_SELINUX_BOOTPARAM"
check_config_builtin
config="CONFIG_SECURITY_SELINUX_BOOTPARAM_VALUE"
value="0"
check_config_value
config="CONFIG_SECURITY_SELINUX_DISABLE"
check_config_builtin

config="CONFIG_SECURITY_SELINUX_POLICYDB_VERSION_MAX"
check_config_builtin
